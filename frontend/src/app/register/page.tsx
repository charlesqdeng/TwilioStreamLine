  ...
  const handleGoogleSignup = async () => {
    try {
      ...
      if (checkResponse.status === 503) {
        setError('Google OAuth is not configured on this server. Please use email/password signup or contact support.');
        return;
      }
      ...
      setError('Failed to initiate Google signup. Please try again or use email/password.');
    }
  };
